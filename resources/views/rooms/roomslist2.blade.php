    ...
    <div class="section properties">
        <div class="container">
            <div class="row properties-box">
                <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 adv">
                    <div class="item card">
                        ...
                        <span class="category">PARADISIAQUE 2</span>
                        <h6>60€</h6>
                        <ul>
                        ...
                        <div class="main-button" value="10">
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 str">
                    <div class="item card">
                        ...
                        <div class="main-button" value="12">
                            <a href="/roomdetails">Faire une réservation</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 align-self-center mb-30 properties-items col-md-6 str">
                    <div class="item card">
                        ...
                        <span class="category">PARADISIAQUE 1</span>
                        <h6>55€</h6>
                        <ul>
                            <li>2 Lit: <span>3 places</span></li>
                            <li>Salles de bain: <span>3</span></li>
                        ...
                        <div class="main-button" value="14">
                            <a href="/roomdetails">Faire une réservation</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="pagination">
                        <li><a href="/roomlist"><<</a></li>
                        <li><a href="/roomlist">1</a></li>
